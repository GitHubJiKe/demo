...
/***/ function(module, exports, __webpack_require__) {
	...
	var PCPicker = React.createClass({displayName: "PCPicker",
		...
		_buildPCCViews: function (viewType) {
			...
			if (views) {
				return views.map(function (v, idx) {
					return (
						React.createElement("p", {key: idx, className: viewType, onClick: self._handleItemClick, onMouseOver: self._handleMouseOver, 
							 style: {margin:'0px',
							 paddingTop:8*scale,
		...
		_openProvinceSelector: function () {
			this.setState({ProvinceModalIsOpen: true, PCCType: PROVINCE_TYPE, pErrorHint: ""});
		},

		_openCityOrCountySelector: function () {
			if (this.state.selectedProvince == null || this.state.selectedProvince == "") {
				this.setState({pErrorHint: "请选择省份!"});
			} else {
		...
		render: function () {
	       ...
	       fontSize:18*scale}}, 
					...
					React.createElement("div", {style: {padding:style.paddingTB}}, 
						React.createElement("div", {style: {pPaddingL:style.pPaddingL,pPaddingR:style.pPaddingR,float:'left'}}, React.createElement("label", null, style.pLabel)
						), 
						React.createElement("input", {type: "input", 
									 ...
									 style: {width: 150*scale,
								 height:20*scale,
	               fontColor:style.inputFontColor,
	               backgroundColor:style.inputBgColor ,
	               borderColor:style.inputBorderColor,
	               fontSize:'80%'}}), 
						React.createElement("div", {style: {color:'red',height:6*scale, fontSize:6*scale}}, state.pErrorHint, " ")
					), 
					...
					React.createElement("div", {style: {padding:style.paddingTB}}, 
						React.createElement("div", {style: {cPaddingL:style.cPaddingL,cPaddingR:style.cPaddingR,float:'left'}}, React.createElement("label", null, style.cLabel)
						), 
						React.createElement("input", {type: "input", 
	...
	ReactDOM.render(
		React.createElement(PCPicker, null),
