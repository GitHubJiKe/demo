	        ...
	        render: function () {
	            ...
	            var buttonsView = state.buttonArr.map(function (v, idx) {
	                return (
	                    React.createElement("p", {key: idx}, 
	                        React.createElement("input", {type: "button", value: v})
	                    )
	                )
	            });
	            var leftDiv = (
	            ...
	            var rightDiv = (
	                React.createElement("div", {style: {border:'solid blue 1px',float:'left',minWidth:'200px',minHeight:'600px'}}, 
	                    React.createElement("input", {id: "button1", type: "button", value: "生成倒计时按钮", onClick: this._addTimerButton})
	                )
	            );

	            console.log("render");
	            return (
	                React.createElement("div", {style: {border:'solid red 1px'}}, 
	                    leftDiv, 
	                    rightDiv
	                )
	            );
