...
module.exports = React.createClass({
	...
	render: function () {
		...
		return (
			<div>
				<input ref="AddressInput" type="text" placeholder={state.placeholder}
				...
				<Modal
					...
					<div style={{width: '300px', heigth: '50px'}}>
						<input type="button" value="省份" onClick={self._ChooseProvince}
									 style={{width: '100px', height: '50px', backgroundColor: state.provincebtnBackgroundColor}}/>
						<input type="button" value="城市" onClick={self._ChooseCity}
									 style={{width: '100px', height: '50px', backgroundColor: state.citybtnBackgroundColor}}/>
						<input type="button" value="县区" onClick={self._ChooseCounty}
