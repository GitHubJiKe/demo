...
/******/ 	__webpack_require__.p = "D:\\project\\node\\demo\\public\\dist";
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var ModalAddressPicker = __webpack_require__(189);
	...
	ReactDOM.render(
		React.createElement(ModalAddressPicker, {onAddressConfirm: function(address) {
	    }})
		,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ModalPortal = React.createFactory(__webpack_require__(171));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var focusManager = __webpack_require__(172);
	var scopeTab = __webpack_require__(174);
	var Assign = __webpack_require__(175);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var findTabbable = __webpack_require__(173);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var baseAssign = __webpack_require__(176),
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Available under MIT license <https://lodash.com/license>
	 */
	var bindCallback = __webpack_require__(183),
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "module.exports",
		...
		_openAddressPicker: function () {
			this._ChooseProvince();
		...
		_ChooseProvince: function () {
			...
			var provinceArray = Object.keys(addressStr).map(function (province, idx) {
				if (provincestamp != null && provincestamp != "") {
					if (provincestamp == province) {
						return (React.createElement("p", {key: idx, onClick: self._selectProvince, onMouseOver: self._handleItemMouseOver, 
						...
						return (
							React.createElement("p", {key: idx, onClick: self._selectProvince, onMouseOver: self._handleItemMouseOver, 
								 onMouseLeave: self._handleItemMouseLeave, 
			...
			this.setState({
				citybtnBackgroundColor: '',
				provincebtnBackgroundColor: "white",
				countybtnBackgroundColor: '',
			...
			if (addressStamp != null && addressStamp != '') {
				...
				var cityarray = Citys.map(function (city, idx) {
					if (citystamp != null && citystamp != '') {
						if (city == citystamp) {
							return (
								React.createElement("p", {key: idx, onClick: self._selectCounty, onMouseOver: self._handleItemMouseOver, 
									 onMouseLeave: self._handleItemMouseLeave, 
									 style: {float: 'left', padding: '5px' ,margin:'0px',backgroundColor:self.state.selectedColor,color:'white'}}, 
									city.toString()
								));
					...
					var countyarray = Countys.map(function (county, idx) {
						if (countystamp != null && countystamp != '') {
							if (countystamp == county) {
								return (React.createElement("p", {key: idx, onClick: self._selectDone, onMouseOver: self._handleItemMouseOver, 
													 onMouseLeave: self._handleItemMouseLeave, 
													 style: {float: 'left', padding: '5px' ,margin:'0px',backgroundColor:self.state.selectedColor,color:'white'}}, 
									county.toString()
								));
		...
		_selectProvince: function (e) {
			var self = this;
			var Citys = Object.keys(addressStr[e.target.innerHTML]);
			var cityarray = Citys.map(function (city, idx) {
				return (
					React.createElement("p", {key: idx, onClick: self._selectCounty, onMouseOver: self._handleItemMouseOver, 
						 onMouseLeave: self._handleItemMouseLeave, 
		...
		_selectCounty: function (e) {
			var self = this;
			var city = e.target.innerHTML;
			var provinceStamp = self.refs.AddressInput.value;
			var province = provinceStamp.split('/')[0];
			var Province = addressStr[province];
			var Countys = Province[city];
			...
			this.setState({
				selectedAddress: province + "/" + e.target.innerHTML,
				citybtnBackgroundColor: '',
				provincebtnBackgroundColor: "",
				countybtnBackgroundColor: 'white',
				displayCity: 'none',
		...
		_selectDone: function (e) {
			...
			if (self.props.onAddressConfirm) {
				self.props.onAddressConfirm(this, selectedAddress);
			}
		},
		...
		render: function () {
			...
			return (
				React.createElement("div", null, 
					React.createElement("input", {ref: "AddressInput", type: "text", placeholder: state.placeholder, 
								 onClick: self._openAddressPicker, 
								 value: state.selectedAddress, style: {width: '250px'}}
					), 
					React.createElement("br", null), 
					React.createElement(Modal, {
						isOpen: this.state.modalIsOpen, 
						style: customStyles}, 
						React.createElement("div", {style: {width: '300px', heigth: '50px'}}, 
							React.createElement("input", {type: "button", value: "省份", onClick: self._ChooseProvince, 
										 style: {width: '100px', height: '50px', backgroundColor: state.provincebtnBackgroundColor}}), 
							React.createElement("input", {type: "button", value: "城市", onClick: self._ChooseCity, 
										 style: {width: '100px', height: '50px', backgroundColor: state.citybtnBackgroundColor}}), 
							React.createElement("input", {type: "button", value: "县区", onClick: self._ChooseCounty, 
										 style: {width: '100px', height: '50px', backgroundColor: state.countybtnBackgroundColor}})
						), 
						React.createElement("br", null), 
						React.createElement("div", {id: "provinceDiv", 
								 style: {width: '300px', heigth: '400px', float: 'left', display: state.displayProvince}}, 
							state.provinceArray
						), 
						React.createElement("div", {id: "cityDiv", 
								 style: {width: '300px', heigth: '400px', float: 'left', display: state.displayCity}}, 
							state.cityArray
						), 
						React.createElement("div", {id: "countyDiv", 
								 style: {width: '300px', heigth: '400px', float: 'left', display: state.displayCounty}}, 
							state.countyArray
						)
					)
				)
