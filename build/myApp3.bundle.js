	...
	var App = React.createClass({displayName: "App",
	    ...
	    render: function () {
	        ...
	        var yearsOptions = state.yearsOptions.map(function (year, idx) {
	            return (React.createElement("option", {key: idx, value: year}, 
	                year
	            ));
	        });
	        var monthsOptions = state.monthsOptions.map(function (month, idx) {
	            return (React.createElement("option", {key: idx, value: month}, 
	                month
	            ));
	        });
	        var daysOptions = state.daysOptions.map(function (day, idx) {
	            return (React.createElement("option", {key: idx, value: day}, 
	                day
	            ));
	        });
	        return (
	            React.createElement("div", null, 
	                React.createElement("input", {onClick: this.openModal, type: "text", value: this.state.value, placeholder: "请选择日期："}), 
	                React.createElement(Modal, {
	                    isOpen: this.state.modalIsOpen, 
	                    onAfterOpen: this.afterOpenModal, 
	                    // onRequestClose={this.closeModal} 如果希望点击外部关闭，添加这行代码
	                    style: customStyles}, 
	                    React.createElement("h2", {ref: "subtitle"}, "选择日期"), 
	                    React.createElement("span", null, "年："), 
	                    React.createElement("select", {id: "yearSelect", name: "yearSelect", style: {width:'100px'}, 
	                            defaultValue: this.getDefaultSelectYear(), onChange: this.getDaysOptions}, 
	                        yearsOptions
	                    ), 
	                    React.createElement("span", null, "月："), 
	                    React.createElement("select", {id: "monthSelect", name: "monthSelect", style: {width:'100px'}, 
	                            defaultValue: this.getDefaultSelectMonth(), onChange: this.getDaysOptions}, 
	                        monthsOptions
	                    ), 
	                    React.createElement("span", null, "日："), 
	                    React.createElement("select", {id: "daySelect", name: "daySelect", style: {width:'100px'}, 
	                            defaultValue: this.getDefaultSelectDay()}, 
	                        daysOptions
	                    ), 
	                    React.createElement("p", null), 
	                    React.createElement("button", {onClick: this.setChoosedDate}, "确定")
	                )
	            )
	        );
	    }
