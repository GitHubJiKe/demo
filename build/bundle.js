...
/***/ function(module, exports, __webpack_require__) {
	...
	var MyDatePicker = __webpack_require__(169);
	var MyInput = __webpack_require__(170);
	...
	var App = React.createClass(
	    {displayName: "App",
	        ...
	        _addYear: function () {
	            var yearInput = window.document.getElementById('year').value;
	            var selectEle = document.getElementById('selector1');
	            if (yearInput.length > 4) {
	                ...
	                optionObj.value = yearInput;
	                optionObj.innerHTML = yearInput;
	        ...
	        _addMonth: function () {
	            ...
	            var selectEle = document.getElementById('selector3');
	            console.log("selectEle = " + selectEle);
	            for (var i = 0; i < innerHTMLs.length; i++) {
	                var optionObj = document.createElement("option");
	                console.log("optionObj1 = " + optionObj);
	                optionObj.value = innerHTMLs[i];
	                console.log("month = " + innerHTMLs[i]);
	                optionObj.innerHTML = innerHTMLs[i];
	                selectEle.appendChild(optionObj);
	            }
	        ...
	        _addDay: function () {
	            ...
	            var selectEle = document.getElementById('selector4');
	            for (var i = 0; i < innerHTMLs.length; i++) {
	                var optionObj = document.createElement("option");
	                console.log("optionObj2 = " + optionObj);
	                optionObj.value = innerHTMLs[i];
	                console.log("day = " + innerHTMLs[i]);
	                optionObj.innerHTML = innerHTMLs[i];
	                selectEle.appendChild(optionObj);
	            }
	        ...
	        render: function () {
	            var leftDiv = (
	                React.createElement("div", {style: {border:'solid red 1px',float:'left',minWidth:'500px',minHeight:'600px'}}, 
	                    React.createElement("input", {type: this.state.buttonType, value: "按钮", id: "myinput"}), React.createElement("br", null), 
	                    React.createElement("span", null, "年："), 
	                    React.createElement("select", {id: "selector1", name: "selector1"}

	                    ), 

	                    React.createElement("span", null, "月："), 
	                    React.createElement("select", {id: "selector3", name: "selector3"}

	                    ), 
	                    React.createElement("span", null, "日："), 
	                    React.createElement("select", {id: "selector4", name: "selector4"}

	                    )
	                )
	            );
	            var rightDiv = (
	                React.createElement("div", {style: {border:'solid blue 1px',float:'left',minWidth:'200px',minHeight:'600px'}}, 
	                    React.createElement("form", null, 
	                        React.createElement("span", null, "选择button类型："), 
	                        React.createElement("select", {id: "selector", name: "selector1", defaultValue: "按钮", onChange: this._changeType}, 
	                            React.createElement("option", {value: "button"}, "按钮"), 
	                            React.createElement("option", {value: "text"}, "文本"), 
	                            React.createElement("option", {value: "checkbox"}, "单选按钮")
	                        )
	                    ), 
	                    React.createElement("span", null, "增加年份："), 
	                    React.createElement("input", {type: "text", id: "year"}), 
	                    React.createElement("input", {type: "button", value: "确定", onClick: this._addYear}), 
	                    React.createElement("p", null, "增加月份："), 
	                    React.createElement("input", {id: "btn_addmonth", type: "button", value: "addMonth", onClick: this._addMonth}), 
	                    React.createElement("p", null, "增加日期："), 
	                    React.createElement("input", {id: "btn_addday", type: "button", value: "addDay", onClick: this._addDay})
	                )
	            );
	            return (
	                React.createElement("div", {style: {border:'solid red 2px'}}, 
	                    leftDiv, 
	                    rightDiv
	                ));
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "module.exports",
	    ...
	    render: function () {
	        return React.createElement("input", {type: this.state.type, value: this.state.value})
	    }
