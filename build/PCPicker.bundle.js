	...
	var PCPicker = React.createClass({displayName: "PCPicker",
		...
		render: function () {
	       ...
	       fontSize:FONT_SIZE*scale}}, 
	          ...
	          React.createElement("textarea", {value: style.pLabel, 
	               ...
	               fontSize:'80%'}}), 
						React.createElement("div", {
							style: {color:'red',height:ERROR_HINT_HEIGHT*scale, fontSize:ERROR_HINT_HEIGHT*scale}}, state.pErrorHint, " ")
					), 
					...
					React.createElement("div", {style: {padding:style.paddingTB}}, 
	            React.createElement("textarea", {value: style.cLabel, 
												rows: style.labelRows, 
												cols: style.labelCols, 
												disabled: "disabled", 
												style: {borderColor:style.labelBdColor,
