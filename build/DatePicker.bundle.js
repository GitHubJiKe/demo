	...
	var DatePicker = React.createClass({displayName: "DatePicker",
		...
		_buildYMDView: function (viewType) {
			...
			return options.map(function (item, idx) {
				return (
					React.createElement("p", {key: idx, onClick: handler, onMouseOver: self._handleMouseOver, 
						 style: {margin:'0px',
	           paddingTop:8*scale,
		...
		render: function () {
			...
			return (
				React.createElement("div", {style: {width:style.formWidth*scale,
	       ...
	       fontSize:FONT_SIZE*scale}}, 
					React.createElement("input", {onClick: this._openModal, type: "text", value: state.value, placeholder: style.placeholder, 
					...
					React.createElement(Modal, {
						...
						React.createElement("div", {id: "container", style: {width:style.formWidth*scale}}, 
							React.createElement("h2", {ref: "subtitle", style: {color:style.mTitleFontColor,fontSize:FONT_SIZE*scale}}, style.mTitle), 
							React.createElement("div", {style: {padding:style.paddingTB}}, 
	              React.createElement("textarea", {value: style.yLabel, 
	                      ...
	                      float:'left'}}
								...
								React.createElement("input", {id: "yearSelect", ref: "yearSelect", 
	                     ...
	                     fontSize:FONT_SIZE*scale,}, 
							...
							React.createElement("div", {style: {padding:style.paddingTB,}}, 
	              React.createElement("textarea", {value: style.mLabel, 
													rows: style.labelRows, 
													cols: style.labelCols, 
													disabled: "disabled", 
													style: {borderColor:style.labelBdColor,
	                      ...
	                      float:'left'}}
								...
								React.createElement("input", {id: "monthSelect", ref: "monthSelect", 
											 style: {width:YMD_INPUT_WIDTH*scale,
	                     height:YMD_INPUT_HEIGHT*scale,
	                     fontSize:FONT_SIZE*scale,}, value: state.monthvalue, 
							...
							React.createElement("div", {style: {padding:style.paddingTB}}, 
	              React.createElement("textarea", {value: style.dLabel, 
													rows: style.labelRows, 
													cols: style.labelCols, 
													disabled: "disabled", 
													style: {borderColor:style.labelBdColor,
	                      ...
	                      float:'left'}}
								...
								React.createElement("input", {id: "daySelect", name: "daySelect", ref: "daySelect", 
											 style: {width:YMD_INPUT_WIDTH*scale,
	                     height:YMD_INPUT_HEIGHT*scale,
	                     fontSize:FONT_SIZE*scale,}, 
							...
							React.createElement("div", null, 
								React.createElement("input", {type: "button", style: {width:style.btnWidth*scale,
