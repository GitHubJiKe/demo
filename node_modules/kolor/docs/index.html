 ...
 */</span>
(<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-params">(define)</span> </span>{</pre></div></div>
        ...
        <li id="section-2">
            ...
            <div class="content"><div class='highlight'><pre>    <span class="hljs-keyword">var</span> kolor;</pre></div></div>
...
a given function.</p>
            ...
            <div class="content"><div class='highlight'><pre>        map: <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-params">(source, callback, context)</span> </span>{
            <span class="hljs-keyword">var</span> results = [];
            <span class="hljs-keyword">var</span> i = source.length;
...
<h4 id="base-hues">Base hues</h4>
        ...
        <span class="hljs-keyword">var</span> l = tokens.length;
        ...
        <span class="hljs-keyword">var</span> t2 = tokens[<span class="hljs-number">0</span>].toLowerCase();
...
<li>PERCENT: 10%, 87.53%, …</li>
    ...
    <span class="hljs-keyword">var</span> NUMBER = <span class="hljs-number">2</span>;
    <span class="hljs-keyword">var</span> PERCENT = <span class="hljs-number">4</span>;
    <span class="hljs-keyword">var</span> HUE = <span class="hljs-number">8</span>;</pre></div></div>
...
<li><em>stringify</em> - produces string value according to actual data value.</li>
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">MOD</span><span class="hljs-params">(value)</span> </span>{
        ...
        <span class="hljs-keyword">this</span>.optional = <span class="hljs-literal">false</span>;
    ...
    Hue.prototype.constructor = Hue;</pre></div></div>
        ...
        HWB: {
            channels: [
                ...
                Channel.create(Ratio, <span class="hljs-string">'alpha'</span>, <span class="hljs-string">'a'</span>, {optional: <span class="hljs-literal">true</span>})
            ],
        ...
        CMYK: {
            channels: [
                Channel.create(Ratio, <span class="hljs-string">'cyan'</span>, <span class="hljs-string">'c'</span>),
                Channel.create(Ratio, <span class="hljs-string">'magenta'</span>, <span class="hljs-string">'m'</span>),
                Channel.create(Ratio, <span class="hljs-string">'yellow'</span>, <span class="hljs-string">'y'</span>),
                Channel.create(Ratio, <span class="hljs-string">'black'</span>, [<span class="hljs-string">'b'</span>, <span class="hljs-string">'k'</span>]),
                Channel.create(Ratio, <span class="hljs-string">'alpha'</span>, <span class="hljs-string">'a'</span>, {optional: <span class="hljs-literal">true</span>})
            ],
            pattern: <span class="hljs-regexp">/(?:device-)?cmyk\(\s*([^,]+?)\s*,\s*([^,]+?)\s*,\s*([^,]+?)\s*,\s*([^,]+?)(?:\s*,\s*([^\)]+?))?\s*\)/i</span>
        }
    };</pre></div></div>
        ...
        <span class="hljs-keyword">var</span> channels = SPACES[space].channels;
        <span class="hljs-keyword">var</span> result = [];

        <span class="hljs-keyword">var</span> l = channels.length;
        ...
        <li id="section-45">
            <div class="annotation">
              ...
              <p>Naively converts RGBA color to CMYK</p>

            </div>
            
            <div class="content"><div class='highlight'><pre>    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">RGBA_TO_CMYK</span><span class="hljs-params">()</span> </span>{
        <span class="hljs-keyword">var</span> r = <span class="hljs-keyword">this</span>.r() / <span class="hljs-number">255</span>;
        <span class="hljs-keyword">var</span> g = <span class="hljs-keyword">this</span>.g() / <span class="hljs-number">255</span>;
        <span class="hljs-keyword">var</span> b = <span class="hljs-keyword">this</span>.b() / <span class="hljs-number">255</span>;
        <span class="hljs-keyword">var</span> black = <span class="hljs-number">1</span> - <span class="hljs-built_in">Math</span>.max(r, g, b);
        ...
        <span class="hljs-keyword">var</span> c = (<span class="hljs-number">1</span> - r - black) / (<span class="hljs-number">1</span> - black);
        <span class="hljs-keyword">var</span> m = (<span class="hljs-number">1</span> - g - black) / (<span class="hljs-number">1</span> - black);
        <span class="hljs-keyword">var</span> y = (<span class="hljs-number">1</span> - b - black) / (<span class="hljs-number">1</span> - black);
        <span class="hljs-keyword">return</span> kolor.cmyk(c, m, y, black, <span class="hljs-keyword">this</span>.a());
    }</pre></div></div>
        ...
        <span class="hljs-keyword">var</span> g = <span class="hljs-keyword">this</span>.g() / <span class="hljs-number">255</span>;
        <span class="hljs-keyword">var</span> b = <span class="hljs-keyword">this</span>.b() / <span class="hljs-number">255</span>;
        <span class="hljs-keyword">var</span> a = <span class="hljs-keyword">this</span>.a();
        ...
        <span class="hljs-keyword">var</span> diff = max - min;
        <span class="hljs-keyword">var</span> sum = max + min;
        ...
        <span class="hljs-keyword">var</span> l = <span class="hljs-keyword">this</span>.l();
        <span class="hljs-keyword">var</span> a = <span class="hljs-keyword">this</span>.a();
        ...
        <span class="hljs-keyword">var</span> hk = h / <span class="hljs-number">360</span>;
        ...
        <span class="hljs-keyword">var</span> v = (l + s) / <span class="hljs-number">2</span>;
        <span class="hljs-keyword">var</span> sv = (<span class="hljs-number">2</span> * s) / (l + s);
        ...
        <span class="hljs-keyword">var</span> h = <span class="hljs-keyword">this</span>.h();
        <span class="hljs-keyword">var</span> s = <span class="hljs-keyword">this</span>.s();
        <span class="hljs-keyword">var</span> v = <span class="hljs-keyword">this</span>.v();
        <span class="hljs-keyword">var</span> a = <span class="hljs-keyword">this</span>.a();
        <span class="hljs-keyword">var</span> hi = <span class="hljs-built_in">Math</span>.floor(h / <span class="hljs-number">60</span>);
        <span class="hljs-keyword">var</span> f = h / <span class="hljs-number">60</span> - hi;
        ...
        <span class="hljs-keyword">var</span> l = (<span class="hljs-number">2</span> - s) * v;
        <span class="hljs-keyword">var</span> sl = s * v;
        sl /= (l &lt;= <span class="hljs-number">1</span>) ? l : <span class="hljs-number">2</span> - l;
        sl = sl || <span class="hljs-number">0</span>;
        l /= <span class="hljs-number">2</span>;
        <span class="hljs-keyword">return</span> kolor.hsla(h, sl, l, a);
    }</pre></div></div>
        ...
        <span class="hljs-keyword">var</span> v = <span class="hljs-keyword">this</span>.v();
        <span class="hljs-keyword">var</span> a = <span class="hljs-keyword">this</span>.a();
        <span class="hljs-keyword">return</span> kolor.hwb(h, (<span class="hljs-number">1</span> - s) * v, <span class="hljs-number">1</span> - v, a);
    }</pre></div></div>
        ...
        <span class="hljs-keyword">var</span> h = <span class="hljs-keyword">this</span>.h();
        <span class="hljs-keyword">var</span> w = <span class="hljs-keyword">this</span>.w();
        ...
        <li id="section-56">
            ...
            <div class="content"><div class='highlight'><pre>    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">CMYK_TO_RGBA</span><span class="hljs-params">()</span> </span>{
        <span class="hljs-keyword">var</span> c = <span class="hljs-keyword">this</span>.c();
        ...
        <span class="hljs-keyword">var</span> black = <span class="hljs-keyword">this</span>.b();
        ...
        <span class="hljs-keyword">var</span> g = <span class="hljs-number">1</span> - <span class="hljs-built_in">Math</span>.min(<span class="hljs-number">1</span>, m * (<span class="hljs-number">1</span> - black) + black);
        <span class="hljs-keyword">var</span> b = <span class="hljs-number">1</span> - <span class="hljs-built_in">Math</span>.min(<span class="hljs-number">1</span>, y * (<span class="hljs-number">1</span> - black) + black);
        <span class="hljs-keyword">return</span> kolor.rgba(r * <span class="hljs-number">255</span>, g * <span class="hljs-number">255</span>, b * <span class="hljs-number">255</span>, <span class="hljs-keyword">this</span>.a());
    }
...
result in RGB colors, while CSS-style expressions specify the output space themselves.</p>
            ...
            <div class="content"><div class='highlight'><pre>    kolor = <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-params">(exp)</span> </span>{</pre></div></div>
        ...
        <li id="section-63">
            <div class="annotation">
              ...
              <p>Try to match hex values, return RGB/RGBA color on success.</p>

            </div>
            
            <div class="content"><div class='highlight'><pre>        <span class="hljs-keyword">var</span> pattern = <span class="hljs-regexp">/^\s*#?([0-9a-f]{3}[0-9a-f]?|[0-9a-f]{6}(?:[0-9a-f]{2})?)\s*$/i</span>;
        <span class="hljs-keyword">var</span> match;
        <span class="hljs-keyword">if</span> (match = exp.match(pattern)) {
            <span class="hljs-keyword">var</span> hex = match[<span class="hljs-number">1</span>];

            <span class="hljs-keyword">if</span> (hex.length &lt;= <span class="hljs-number">4</span>) {
                hex = util.map(hex.split(<span class="hljs-string">''</span>), <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-params">(ch)</span> </span>{
                    <span class="hljs-keyword">return</span> ch + ch;
                }).join(<span class="hljs-string">''</span>);
            }

            <span class="hljs-keyword">var</span> channels = util.map(hex.match(<span class="hljs-regexp">/\w{2}/g</span>), <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-params">(val, i)</span> </span>{
                <span class="hljs-keyword">var</span> decimal = <span class="hljs-built_in">parseInt</span>(val, <span class="hljs-number">16</span>);
                <span class="hljs-keyword">return</span> i === <span class="hljs-number">3</span> ? decimal * <span class="hljs-number">100</span> / <span class="hljs-number">255</span> + <span class="hljs-string">'%'</span> : decimal;
            });

            <span class="hljs-keyword">var</span> space = channels.length === <span class="hljs-number">4</span> ? <span class="hljs-string">'RGBA'</span> : <span class="hljs-string">'RGB'</span>;
            <span class="hljs-keyword">return</span> <span class="hljs-keyword">new</span> kolor[space](channels);
        }</pre></div></div>
        ...
        <li id="section-64">
            ...
            <span class="hljs-keyword">if</span> (match) {
                <span class="hljs-keyword">var</span> args = match.slice(<span class="hljs-number">1</span>);
...
<li>kolor.rgb({ r: 255, g: 0, b: 0 })</li>
            ...
            <span class="hljs-keyword">return</span> <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-params">()</span> </span>{
                ...
                <span class="hljs-keyword">var</span> type = util.typeOf(args[<span class="hljs-number">0</span>]);
        ...
        <span class="hljs-keyword">var</span> channels = space.channels;</pre></div></div>
...
<p>When <code>kolor</code> is used as a factory method, it will call these constructors.</p>
            ...
            <span class="hljs-keyword">return</span> <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-params">(args)</span> </span>{
                ...
                <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = l; i--;) {
                    ...
                    <span class="hljs-keyword">var</span> name = channel.name;
                    <span class="hljs-keyword">var</span> alias = channel.alias;
                    ...
                    <span class="hljs-keyword">if</span> (args[i] != <span class="hljs-literal">null</span>) {
                        ...
                        <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> j = <span class="hljs-number">0</span>, k = alias.length; j &lt; k; j++) {
                            <span class="hljs-keyword">if</span> (util.has(args, alias[j])) {
                                param = args[alias[j]];
                                <span class="hljs-keyword">break</span>;
                            }
                        }
...
getter.</p>
            ...
            kolor[key].prototype[channel.name] = <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-params">(i)</span> </span>{
                <span class="hljs-keyword">var</span> channel = channels[i];
                <span class="hljs-keyword">var</span> prop = <span class="hljs-string">'_'</span> + channel.alias;
...
<p>By CSS-style string we mean something like <code>rgba(255, 0, 0, 0.5)</code>, <code>hsl(30, 80%, 100%)</code>, etc.</p>
            ...
            <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; l; i++) {
                channel = channels[i];
                value = <span class="hljs-keyword">this</span>[channel.name]();
                <span class="hljs-keyword">if</span> (value === channel.initial &amp;&amp; channel.optional) {
                    <span class="hljs-keyword">continue</span>;
                }
...
<li><em>color</em> - the color to be copied from.</li>
            ...
            <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = channels.length; i--;) {
...
<p>Returns a new color object in the same space as the original one.</p>
            ...
            <span class="hljs-keyword">var</span> src = color.rgba();
            <span class="hljs-keyword">var</span> p = proportion == <span class="hljs-literal">null</span> ? <span class="hljs-number">0.5</span> : proportion;
            <span class="hljs-keyword">var</span> w = p * <span class="hljs-number">2</span> - <span class="hljs-number">1</span>;
            <span class="hljs-keyword">var</span> a = dest.a() - src.a();
            <span class="hljs-keyword">var</span> w1 = (((w * a === -<span class="hljs-number">1</span>) ? w : (w + a) / (<span class="hljs-number">1</span> + w * a)) + <span class="hljs-number">1</span>) / <span class="hljs-number">2</span>;
...
<h5 id="return-values">Return values</h5>
<p>Returns a new color object after increasing alpha in the original space adding
an alpha channel.
...
into RGBA.</p>
            ...
            <span class="hljs-keyword">if</span> (util.has(SPACES, space)) {
                color = <span class="hljs-keyword">this</span>[space.toLowerCase()]();
            } <span class="hljs-keyword">else</span> {
                color = <span class="hljs-keyword">this</span>.rgba();
            }
...
<p>The calculated luminance value.</p>
            ...
            <span class="hljs-keyword">var</span> r = convert(color.r());
            <span class="hljs-keyword">var</span> g = convert(color.g());
            <span class="hljs-keyword">var</span> b = convert(color.b());
...
<p>The calculated contrast ratio.</p>
            ...
            <span class="hljs-keyword">var</span> l2 = color.luminance();
...
Otherwise, returns an array such colors.</p>
        ...
        <span class="hljs-keyword">var</span> h = getValue(options.h, [<span class="hljs-number">0</span>, <span class="hljs-number">360</span>]);
        <span class="hljs-keyword">var</span> interval = <span class="hljs-built_in">Math</span>.floor(((<span class="hljs-number">360</span> + (h[<span class="hljs-number">1</span>] - h[<span class="hljs-number">0</span>])) % <span class="hljs-number">360</span> || <span class="hljs-number">360</span>) / size);
        <span class="hljs-keyword">var</span> offset = <span class="hljs-built_in">Math</span>.random() * interval;
        <span class="hljs-keyword">var</span> s = getValue(options.s, [<span class="hljs-number">0</span>, <span class="hljs-number">1</span>]);
        <span class="hljs-keyword">var</span> l = getValue(options.l, [<span class="hljs-number">0</span>, <span class="hljs-number">1</span>]);
        <span class="hljs-keyword">var</span> a = getValue(options.a, <span class="hljs-number">1</span>);
        <span class="hljs-keyword">var</span> shuffle = getValue(options.shuffle, <span class="hljs-literal">true</span>);
        <span class="hljs-keyword">var</span> space = (options.space || <span class="hljs-string">'hex'</span>).toLowerCase();
        ...
        <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; size; i++) {
            <span class="hljs-keyword">var</span> color = kolor.hsla(
